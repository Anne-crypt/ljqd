...
---
<div class="intro">
  <img src="{{'/assets/images/banner.avif' | url}}" fetchpriority="high" loading="eager" alt="Photo" class="intro__image">
  <div class="intro__text">
    ...
    <p>La compagnie revendique une approche pluridisciplinaire : théâtre, chant, acrobatie, dessin, mime s’invitent dans l’écriture chorégraphique, non comme des ornements, mais comme des outils au service du propos. Ce langage hybride permet de créer des œuvres narratives, accessibles et poétiques. </p>
  </div>
</div>